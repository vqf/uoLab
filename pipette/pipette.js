...
import { loadSVGTag } from '../loadTag.js';
  ...
  content: [
    {
      ...
      d: 'm 12.287303,78.916993 c 0,0 0,2.90619 0,2.90619 0,0 0.88869,0 0.88869,0 0,0 0,-2.90619 0,-2.90619 0,0 -0.88869,0 -0.88869,0',
    },
    {
      tag: 'g',
      ...
      content: [
        {
          ...
          d: 'm 14.716153,14.653093 c 0,0 -0.0305,-5.7911103 -0.0305,-5.7911103 0,0 5.46721,0.77654 5.46721,0.77654 0,0 0.17196,1.2037203 0.17196,1.2037203 0,0 -2.75135,0 -2.75135,0 0,0 0.008,4.05469 0.008,4.05469 0,0 -2.86507,0 -2.86507,0 0,0 -2.5e-4,-0.24384 -2.5e-4,-0.24384 z',
        },
        {
          tag: 'path',
          class: 'pipette_rod',
          d: 'm 9.4914128,46.411173 c 0,0 6.5344502,5e-5 6.5344502,5e-5 0,0 0.17196,4.32555 0.17196,4.32555 0,0 -2.235823,2.23547 -2.235823,2.23547 0,6.815137 0,13.630009 -0.09328,17.954122 -0.09328,4.324113 -0.279889,6.157515 -0.466472,7.990628 0,0 -1.38962,0 -1.38962,0 C 11.7586,77.08388 11.504538,75.250546 11.34228,70.926386 11.180022,66.602226 11.109512,59.787346 11.039,52.972193 c 0,0 -1.3756273,-1.71959 -1.3756273,-1.71959 0,0 -0.1719599,-4.84143 -0.1719599,-4.84143',
        },
      ],
    },
    {
...
let yellow_tip = {
  ...
  content: {
    ...
    id: 'ytip',
    class: 'yellow_tip',
    d: 'm 13.325755,89.800433 c 0.126663,-2.206485 0.253271,-3.185743 0.379918,-4.165296 -0.316623,0.02967 -0.632961,0.05931 -0.949756,0.05932 -0.316795,1.1e-5 -0.633361,-0.02965 -0.949984,-0.05932 0.12665,0.979553 0.253242,1.958659 0.379931,4.165614 0.126688,2.206956 0.253319,5.639813 0.379969,9.073196 0,0 0.37995,0 0.37995,0 0.12665,-3.433383 0.25331,-6.867029 0.379972,-9.073514 z',
  },
};
...
export class pipette extends plugger {
  ...
  loadTip() {
    ...
    if (tp instanceof tip) {
      ...
      this.move(destx, desty, 0.5).then().move(0, fy, 0.2).then(f);
    }
  }
  _initInjected() {
    super._initInjected();
